...
Функция ОборотыФР_Z_Отчет(Рез_ОборотыФР) Экспорт
	...
	Попытка
		Если пЭККР.FPGetDayReportProperties () Тогда
			Рез_ОборотыФР.ФР_Номер_Z_Отчета = Число(пЭККР.prCurrentZReport);
		...
		КонецЕсли;	
	Исключение
		Рез_ОборотыФР.ФР_Номер_Z_Отчета = 0;	
	КонецПопытки;
	...
	Попытка
		...
		Рез_ОборотыФР.ФР_ОборотПродаж_А 	= Число(пЭККР.prDaySumAddTaxOfSale1)*0.01;
		Рез_ОборотыФР.ФР_ОборотПродаж_Б		= Число(пЭККР.prDaySumAddTaxOfSale2)*0.01;
		Рез_ОборотыФР.ФР_ОборотПродаж_В		= Число(пЭККР.prDaySumAddTaxOfSale3)*0.01;
		Рез_ОборотыФР.ФР_ОборотПродаж_Г		= Число(пЭККР.prDaySumAddTaxOfSale4)*0.01;
		Рез_ОборотыФР.ФР_ОборотПродаж_Д		= Число(пЭККР.prDaySumAddTaxOfSale5)*0.01;
		Рез_ОборотыФР.ФР_ОборотПродаж_Е		= Число(пЭККР.prDaySumAddTaxOfSale6)*0.01;
		
		Рез_ОборотыФР.ФР_ОборотВозврат_А	= Число(пЭККР.prDaySumAddTaxOfRefund1)*0.01;
		Рез_ОборотыФР.ФР_ОборотВозврат_Б	= Число(пЭККР.prDaySumAddTaxOfRefund2)*0.01;
		Рез_ОборотыФР.ФР_ОборотВозврат_В	= Число(пЭККР.prDaySumAddTaxOfRefund3)*0.01;
		Рез_ОборотыФР.ФР_ОборотВозврат_Г	= Число(пЭККР.prDaySumAddTaxOfRefund4)*0.01;
		Рез_ОборотыФР.ФР_ОборотВозврат_Д	= Число(пЭККР.prDaySumAddTaxOfRefund5)*0.01;
		Рез_ОборотыФР.ФР_ОборотВозврат_Е	= Число(пЭККР.prDaySumAddTaxOfRefund6)*0.01;
		...
		Рез_ОборотыФР.ФР_СуммаВнесение 	= Число(пЭККР.prDayCashInSum)*0.01;
		Рез_ОборотыФР.ФР_СуммаИзъятие 	= Число(пЭККР.prDayCashOutSum)*0.01;
		
		Рез_ОборотыФР.ФР_СуммаСкидокПродажа = Число(пЭККР.prDayDiscountSumOnSales)*0.01;
		Рез_ОборотыФР.ФР_СуммаСкидокВозврат = Число(пЭККР.prDayDiscountSumOnRefunds)*0.01;
		
		Если НЕ пЭККР.FPGetTaxRates() Тогда
			ОшибкаСообщить(пЭККР);	
			Результат = Ложь;
			Возврат Рез_ОборотыФР;
		КонецЕсли;
		
		Рез_ОборотыФР.ФР_СтавкаНалога_А 	= Число(пЭККР.prTaxRate1)*100;
		Рез_ОборотыФР.ФР_СтавкаНалога_Б		= Число(пЭККР.prTaxRate2)*100;
		Рез_ОборотыФР.ФР_СтавкаНалога_В		= Число(пЭККР.prTaxRate3)*100;
		Рез_ОборотыФР.ФР_СтавкаНалога_Г		= Число(пЭККР.prTaxRate4)*100;
		Рез_ОборотыФР.ФР_СтавкаНалога_Д		= Число(пЭККР.prTaxRate5)*100;
