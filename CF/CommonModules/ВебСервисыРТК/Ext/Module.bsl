...
Процедура BAS_РОЗНИЦА_ОправитьSALE(ВсеЧекиЗаДень = Неопределено) Экспорт
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ТаблицаДвижениеПС 	= ОбщегоНазначения.ПолучитьТЧ_ДвиженияПСЧекаККМ_ОтправитьНаСервер(ВыборкаДетальныеЗаписи.Ссылка);
		
		РезультатСервиса = Прокси.ЗаписатьДокументЧекККМ(ТаблицаШапка, ТаблицаТовары, ТаблицаСкидки, ТаблицаДвижениеПС);
