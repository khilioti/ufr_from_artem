...
Процедура ОтправитьДанныеПоВебСервису() Экспорт
	...
	Исключение
		Логирование.ДобавитьЗаписьЖурнала(УровеньЖурналаРегистрации.Ошибка, "КнопкаZотчетНажатие()", ОписаниеОшибки(), Неопределено, Неопределено, "Обработки.РМК.Формы.Форма");
	КонецПопытки;	
