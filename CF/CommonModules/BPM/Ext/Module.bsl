	...
	Попытка
		...
		Для Каждого СтрокаТЧ Из ТЧ_Продажа Цикл
			...
			ИначеЕсли СтрокаТЧ.Акционный = 1 Тогда // желтые ценники
				Структура_ТЧ_Товар.Вставить("DontUseInPreprocessing", 	Истина);
			ИначеЕсли СтрокаТЧ.Акционный = 2 Тогда // акцизный товар
				Структура_ТЧ_Товар.Вставить("DontUseInPreprocessing", 	Истина);
...
Функция ПараметрыBPM7_Очистить(ОчиститьОбьект=Истина, ОчиститьШК=Истина) Экспорт 
	...
	ПараметрыBPM7.Вставить("Таймаут", 15);
