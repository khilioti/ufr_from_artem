 	...
 	Если НЕ ПустаяСтрока(ПараметрыBPM7.BPMonline_ШК)  Тогда                    	
		...
		Иначе 
			...
			Если ПараметрыBPM7.BPMonline_БонусыНачисленные > 0 Тогда 
				...
				МассивСтрок.Добавить("Бонусні гривні можна використати вже наступного дня");
				МассивСтрок.Добавить("Нараховані бонусні гривні діють до " + ДатаОкончанияДействияБонусов);
