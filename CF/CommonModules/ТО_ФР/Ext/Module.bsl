...
Функция ОпределитьНеобходимостьПечати(ВидОперации)
...
Функция ФормированиеКомментаДляЧекаФР(Объект)
	...
	//Мулько 26.03.2020
	//Добавим печать слова ПОВЕРНЕННЯ
	Если ПараметрыЧекаККМ.ВидОплаты = Перечисления.ВидыОплатЧекаККМ.Нал Тогда
		Если ПараметрыЧекаККМ.ВидОперации = Перечисления.ВидыОперацийЧекККМ.Возврат Тогда
			НадоПечатать = ОпределитьНеобходимостьПечати(ПараметрыЧекаККМ.ВидОперации);
