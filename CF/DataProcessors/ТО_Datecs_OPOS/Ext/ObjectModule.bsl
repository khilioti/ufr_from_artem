...
Функция ОборотыФР_Z_Отчет(Рез_ОборотыФР) Экспорт
	...
	//Попытка
		...
		Рез_ОборотыФР.ФР_Номер_Z_Отчета = Число(пЭККР.ReservedWord);
		
		пЭККР.DirectIO(66,0,"000000;");
		Рез_ОборотыФР.ФР_СерийныйНомер = СтрЗаменить(пЭККР.ReservedWord,";","");
		...
		Рез_ОборотыФР.ФР_ОборотиВозвратов_БезНал	= ?(ПустаяСтрока(Строка_ФР_ОборотиВозвратов_БезНал), 	0, (-1) * Число(Строка_ФР_ОборотиВозвратов_БезНал));
		Рез_ОборотыФР.ФР_ОборотиВозвратов_Нал		= ?(ПустаяСтрока(Строка_ФР_ОборотиВозвратов_Нал),		0, (-1) * Число(Строка_ФР_ОборотиВозвратов_Нал));
		Рез_ОборотыФР.ФР_ОборотиВозвратов_ПС		= ?(ПустаяСтрока(Строка_ФР_ОборотиВозвратов_ПС), 		0, (-1) * Число(Строка_ФР_ОборотиВозвратов_ПС));
		Рез_ОборотыФР.ФР_ОборотиВозвратов_Ваучер	= ?(ПустаяСтрока(Строка_ФР_ОборотиВозвратов_Ваучер), 	0, (-1) * Число(Строка_ФР_ОборотиВозвратов_Ваучер));
		...
		//-----------------------------------	
		пЭККР.DirectIO(226,0,"000000;1;");
		КолЧековПродажа = пЭККР.ReservedWord;
		
		пЭККР.DirectIO(226,0,"000000;2;");
		КолЧековВозврат = пЭККР.ReservedWord;
		
		Рез_ОборотыФР.ФР_КоличествоЧеков_Продажа = ?(ПустаяСтрока(КолЧековПродажа), 0, Число(КолЧековПродажа));
		Рез_ОборотыФР.ФР_КоличествоЧеков_Возврат = ?(ПустаяСтрока(КолЧековВозврат), 0, Число(КолЧековВозврат));
		...
		Строка_ФР_ОборотПродаж_А = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотПродаж_А		= ?(ПустаяСтрока(Строка_ФР_ОборотПродаж_А), 0, Число(Строка_ФР_ОборотПродаж_А));
		
		пЭККР.DirectIO(224,1,"000000;0;0;0;");
		Строка_ФР_ОборотВозврат_А = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотВозврат_А	= ?(ПустаяСтрока(Строка_ФР_ОборотВозврат_А), 0, (-1) * Число(Строка_ФР_ОборотВозврат_А));

		пЭККР.DirectIO(224,0,"000000;0;1;0;");
		Строка_ФР_ОборотПродаж_Б = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотПродаж_Б		= ?(ПустаяСтрока(Строка_ФР_ОборотПродаж_Б), 0, Число(Строка_ФР_ОборотПродаж_Б));
		
		пЭККР.DirectIO(224,1,"000000;0;1;0;");
		Строка_ФР_ОборотВозврат_Б = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотВозврат_Б	= ?(ПустаяСтрока(Строка_ФР_ОборотВозврат_Б), 0, (-1) * Число(Строка_ФР_ОборотВозврат_Б));
			
		пЭККР.DirectIO(224,0,"000000;0;2;0;");
		Строка_ФР_ОборотПродаж_В = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотПродаж_В		= ?(ПустаяСтрока(Строка_ФР_ОборотПродаж_В), 0, Число(Строка_ФР_ОборотПродаж_В));
		
		пЭККР.DirectIO(224,1,"000000;0;2;0;");
		Строка_ФР_ОборотВозврат_В = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотВозврат_В	= ?(ПустаяСтрока(Строка_ФР_ОборотВозврат_В), 0, (-1) * Число(Строка_ФР_ОборотВозврат_В));
		
		пЭККР.DirectIO(224,0,"000000;0;3;0;");
		Строка_ФР_ОборотПродаж_Г = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотПродаж_Г		= ?(ПустаяСтрока(Строка_ФР_ОборотПродаж_Г), 0, Число(Строка_ФР_ОборотПродаж_Г));
		
		пЭККР.DirectIO(224,1,"000000;0;3;0;");
		Строка_ФР_ОборотВозврат_Г = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотВозврат_Г	= ?(ПустаяСтрока(Строка_ФР_ОборотВозврат_Г), 0, (-1) * Число(Строка_ФР_ОборотВозврат_Г));
		
		пЭККР.DirectIO(224,0,"000000;0;4;0;");
		Строка_ФР_ОборотПродаж_Д = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотПродаж_Д		= ?(ПустаяСтрока(Строка_ФР_ОборотПродаж_Д), 0, Число(Строка_ФР_ОборотПродаж_Д));
		
		пЭККР.DirectIO(224,1,"000000;0;4;0;");
		Строка_ФР_ОборотВозврат_Д = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_ОборотВозврат_Д	= ?(ПустаяСтрока(Строка_ФР_ОборотВозврат_Д), 0, (-1) * Число(Строка_ФР_ОборотВозврат_Д));
		
		
		
		
		//-----------------------------------
		пЭККР.DirectIO(224,0,"000000;1;0;0;");
		Строка_ФР_НДСПродаж_А = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСПродаж_А		= ?(ПустаяСтрока(Строка_ФР_НДСПродаж_А), 0, Число(Строка_ФР_НДСПродаж_А));
		
		пЭККР.DirectIO(224,1,"000000;1;0;0;");
		Строка_ФР_НДСВозврат_А = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСВозврат_А	= ?(ПустаяСтрока(Строка_ФР_НДСВозврат_А), 0, (-1) * Число(Строка_ФР_НДСВозврат_А));

		пЭККР.DirectIO(224,0,"000000;1;1;0;");
		Строка_ФР_НДСПродаж_Б = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСПродаж_Б		= ?(ПустаяСтрока(Строка_ФР_НДСПродаж_Б), 0, Число(Строка_ФР_НДСПродаж_Б));
		
		пЭККР.DirectIO(224,1,"000000;1;1;0;");
		Строка_ФР_НДСВозврат_Б = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСВозврат_Б	= ?(ПустаяСтрока(Строка_ФР_НДСВозврат_Б), 0, (-1) * Число(Строка_ФР_НДСВозврат_Б));
			
		пЭККР.DirectIO(224,0,"000000;1;2;0;");
		Строка_ФР_НДСПродаж_В = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСПродаж_В		= ?(ПустаяСтрока(Строка_ФР_НДСПродаж_В), 0, Число(Строка_ФР_НДСПродаж_В));
		
		пЭККР.DirectIO(224,1,"000000;1;2;0;");
		Строка_ФР_НДСВозврат_В = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСВозврат_В	= ?(ПустаяСтрока(Строка_ФР_НДСВозврат_В), 0, (-1) * Число(Строка_ФР_НДСВозврат_В));
		
		пЭККР.DirectIO(224,0,"000000;1;3;0;");
		Строка_ФР_НДСПродаж_Г = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСПродаж_Г		= ?(ПустаяСтрока(Строка_ФР_НДСПродаж_Г), 0, Число(Строка_ФР_НДСПродаж_Г));
		
		пЭККР.DirectIO(224,1,"000000;1;3;0;");
		Строка_ФР_НДСВозврат_Г = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСВозврат_Г	= ?(ПустаяСтрока(Строка_ФР_НДСВозврат_Г), 0, (-1) * Число(Строка_ФР_НДСВозврат_Г));
		
		пЭККР.DirectIO(224,0,"000000;1;4;0;");
		Строка_ФР_НДСПродаж_Д = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСПродаж_Д		= ?(ПустаяСтрока(Строка_ФР_НДСПродаж_Д), 0, Число(Строка_ФР_НДСПродаж_Д));
		
		пЭККР.DirectIO(224,1,"000000;1;4;0;");
		Строка_ФР_НДСВозврат_Д = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_НДСВозврат_Д	= ?(ПустаяСтрока(Строка_ФР_НДСВозврат_Д), 0, (-1) * Число(Строка_ФР_НДСВозврат_Д));
		
		//-----------------------------------
		пЭККР.DirectIO(72,1,"000000;0;");
		Строка_ФР_СтавкаНалога_А = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_СтавкаНалога_А	= ?(ПустаяСтрока(Строка_ФР_СтавкаНалога_А), 0, Число(Строка_ФР_СтавкаНалога_А));
		
		пЭККР.DirectIO(72,1,"000000;1;");
		Строка_ФР_СтавкаНалога_Б = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_СтавкаНалога_Б	= ?(ПустаяСтрока(Строка_ФР_СтавкаНалога_Б), 0, Число(Строка_ФР_СтавкаНалога_Б));
		
		пЭККР.DirectIO(72,1,"000000;2;");
		Строка_ФР_СтавкаНалога_В = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_СтавкаНалога_В	= ?(ПустаяСтрока(Строка_ФР_СтавкаНалога_В), 0, Число(Строка_ФР_СтавкаНалога_В));
		
		пЭККР.DirectIO(72,1,"000000;3;");
		Строка_ФР_СтавкаНалога_Г = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_СтавкаНалога_Г	= ?(ПустаяСтрока(Строка_ФР_СтавкаНалога_Г), 0, Число(Строка_ФР_СтавкаНалога_Г));
		
		пЭККР.DirectIO(72,1,"000000;4;");
		Строка_ФР_СтавкаНалога_Д = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_СтавкаНалога_Д	= ?(ПустаяСтрока(Строка_ФР_СтавкаНалога_Д), 0, Число(Строка_ФР_СтавкаНалога_Д));
		
		//-----------------------------------
		пЭККР.DirectIO(224,0,"000000;3;1;0;");
		Строка_ФР_СуммаВнесение = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_СуммаВнесение		= ?(ПустаяСтрока(Строка_ФР_СуммаВнесение), 0, Число(Строка_ФР_СуммаВнесение));
		
		пЭККР.DirectIO(224,1,"000000;3;1;0;");
		Строка_ФР_СуммаИзъятие = пЭККР.ReservedWord;
		Рез_ОборотыФР.ФР_СуммаИзъятие		= ?(ПустаяСтрока(Строка_ФР_СуммаИзъятие), 0, (-1) * Число(Строка_ФР_СуммаИзъятие));
