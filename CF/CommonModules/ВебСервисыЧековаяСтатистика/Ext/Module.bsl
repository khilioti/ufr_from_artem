...
Процедура РОЗНИЦА_ОправитьSALE(ВсеЧекиЗаДень = Неопределено) Экспорт
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ТЧ_Товары															= ПолучитьТЧ_ТоварыЧекаККМ_ОтправитьНаСервер(ВыборкаДетальныеЗаписи.Ссылка);
		...
		ТЧ_ЖурналСкидок														= ПолучитьТЧ_ЖурналСкидокЧекаККМ_ОтправитьНаСервер(ВыборкаДетальныеЗаписи.Ссылка);
		...
		ТЧ_ДвиженияПС														= ПолучитьТЧ_ДвиженияПСЧекаККМ_ОтправитьНаСервер(ВыборкаДетальныеЗаписи.Ссылка);
		...
		ТЧ_СобытияПоЧеку													= ПолучитьТЧ_СобытияПоЧекуЧекаККМ_ОтправитьНаСервер(ВыборкаДетальныеЗаписи.Ссылка);
...
Функция ПодключитьПрокси(WSDL, URIПространстваИменСервиса, ИмяСервиса, Таймаут)
	...
	НастройкаОбменаДанными.Вставить("WSАдрес",					"http://1c.prostor.ua/roznica/ws/" + WSDL);
...
Функция ПолучитьТЧ_ТоварыЧекаККМ_ОтправитьНаСервер(Ссылка)
...
Функция ПолучитьТЧ_ЖурналСкидокЧекаККМ_ОтправитьНаСервер(Ссылка)
		//{{КОНСТРУКТОР_ЗАПРОСА_С_ОБРАБОТКОЙ_РЕЗУЛЬТАТА
	// Данный фрагмент построен конструктором.
	// При повторном использовании конструктора, внесенные вручную изменения будут утеряны!!!
...
Функция ПолучитьТЧ_ДвиженияПСЧекаККМ_ОтправитьНаСервер(Ссылка)
		//{{КОНСТРУКТОР_ЗАПРОСА_С_ОБРАБОТКОЙ_РЕЗУЛЬТАТА
	// Данный фрагмент построен конструктором.
	// При повторном использовании конструктора, внесенные вручную изменения будут утеряны!!!
...
Функция ПолучитьТЧ_СобытияПоЧекуЧекаККМ_ОтправитьНаСервер(Ссылка)
		//{{КОНСТРУКТОР_ЗАПРОСА_С_ОБРАБОТКОЙ_РЕЗУЛЬТАТА
	// Данный фрагмент построен конструктором.
	// При повторном использовании конструктора, внесенные вручную изменения будут утеряны!!!
...
Функция СоздатьLogFile(ДатаВыгрузки)
	...
	МассивСтрок.Добавить("FISHKA_ОплатаЧерезСМС");
